<template>
  <div>
    <div class="text-help">
      {{ $t(`datashield_${env}_methods_info`) }}
    </div>
    <q-table
      flat
    ...
    <confirm-dialog v-model="showDelete" :title="$t('delete')" :text="$t('delete_datashield_methods_confirm', { count: selected.length })" @confirm="onDeleteMethods" />
