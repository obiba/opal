<template>
  <div>
    <q-tabs v-model="type" dense class="text-grey" active-color="primary" indicator-color="primary" align="justify">
          ...
          <div class="row q-gutter-md">
            ...
            <div class="col">
              <q-tab-panels v-model="tab">
                <q-tab-panel v-for="grp in groups" :key="grp" :name="grp" style="padding-top: 0">
...
const groupAclsCount = computed(() =>
  profileAclsStore.groupAcls
    ? Object.keys(profileAclsStore.groupAcls)
        .map((grp) => (profileAclsStore.groupAcls[grp] ? 1 : 0))
