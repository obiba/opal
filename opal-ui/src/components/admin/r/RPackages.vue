          ...
          <q-td key="name" :props="props">
            ...
            <div class="float-right">
              <q-btn rounded dense flat size="sm" color="secondary"
                :icon="packageToolsVisible[getPackageKey(props.row)] ? 'visibility' : 'none'" class="q-ml-xs"
              ...
              <q-btn v-if="systemStore.generalConf.allowRPackageManagement" rounded dense flat size="sm"
                ...
                :icon="packageToolsVisible[getPackageKey(props.row)] ? 'delete' : 'none'" class="q-ml-xs"
