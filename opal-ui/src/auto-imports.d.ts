...
declare global {
  ...
  import('vue')
  // @ts-ignore
  export type { GenerateIdentifiersOptions } from './stores/identifiers'
  import('./stores/identifiers')
  // @ts-ignore
  export type { PiniaCustomProperties } from './stores/index'
  import('./stores/index')
  // @ts-ignore
  export type { ItemFieldsResultDto, SearchQuery, SearchCriteria } from './stores/search'
  import('./stores/search')
  // @ts-ignore
  export type { TaxonomiesImportOptions } from './stores/taxonomies'
  import('./stores/taxonomies')
  // @ts-ignore
...
declare module 'vue' {
  ...
  interface ComponentCustomProperties {
    ...
    readonly useAppsStore: UnwrapRef<typeof import('./stores/apps')['useAppsStore']>
    readonly useAttrs: UnwrapRef<typeof import('vue')['useAttrs']>
    readonly useAuthStore: UnwrapRef<typeof import('./stores/auth')['useAuthStore']>
    readonly useAuthzStore: UnwrapRef<typeof import('./stores/authz')['useAuthzStore']>
