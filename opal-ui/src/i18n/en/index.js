export default {
  ...
  db: {
    ...
    owner_project_hint: 'This database belongs to a project and is managed by Opal.',
    delete_files: 'Also delete the database files',
    delete_files_hint: 'The H2 database is a file in the Opal data folder. Left in place, it keeps the credentials it was created with, and registering a database again at the same URL with a different password will not be able to open it.',
    delete_internal_confirm: "Are you sure you want to delete this database '{name}'? Note that the data and its files WILL be permanently deleted.",
  ...
  kubernetes: {
    ...
    rock_info: 'Rock is an R server with a REST API (see {url} project). Rock pods created on-demand offer a scalable and secure R analysis capability.',
    add_pod_spec: 'Add Pod Specification',
    edit_pod_spec: 'Edit Pod Specification',
    id_hint: 'The unique identifier of the pod specification, which will be used to name the R profile.',
    namespace: 'Namespace',
    ...
    environment_hint: 'The environment variables to be set in the pod.',
    image: 'Image',
    image_hint: 'The Docker image to be used for the pods.',
    image_pull_policy: 'Image pull policy',
    image_pull_policy_hint: 'The policy to be used for pulling the Docker image.',
    image_pull_secret: 'Image pull secret',
    image_pull_secret_hint: 'The Kubernetes secret to be used for pulling the Docker image from a private repository.',
    resources_requests: 'Resource requests',
    resources_requests_hint: 'The minimum resources required by the pod.',
    resources_limits: 'Resource limits',
    ...
    node: 'Node',
    node_hint: 'The different strategies for assigning a pod to a Kubernetes node. If not specified, the scheduler will choose a node.',
    node_name: 'Node name',
    node_name_hint: 'The name of the Kubernetes node on which the pod will be scheduled. If not specified, the scheduler will choose a node.',
  ...
  validation: {
    r_quota: {
      subject_required: 'A group or user name is required',
      limit_required: 'A limit of zero minutes or more is required',
    },
  ...
  r_quota: {
    title: 'Quotas',
    info: 'A quota limits what a user may spend on DataSHIELD over a rolling window, either of R execution time or of R session time. The window rolls: there is no reset, capacity returns as past activity ages out of it. A user gets their own quota if they have one, otherwise the most permissive of the quotas of the groups they belong to, otherwise the system default. The two metrics are resolved separately, so a subject can be given one quota of each, and where neither applies usage is unlimited.',
    add: 'Add quota',
    edit: 'Edit quota',
    user: 'User',
    group: 'Group',
    delete_confirm: 'Are you sure you want to delete the quota of {subject}? Its subject becomes unlimited, unless a broader quota still applies to them.',
    subject: 'Subject',
    subject_type: 'Applies to',
    subject_type_hint: 'A quota applies to everyone (system default), to the members of a group, or to a single user.',
    system_default: 'System default',
    group_hint: 'The name of the group the quota applies to. A user in several groups gets the most permissive of their quotas.',
    user_hint: 'The name of the user the quota applies to. A personal quota overrides any group quota and the system default.',
    metric: 'Metric',
    metric_hint: "What the allowance is spent on. Execution time bills the R server's cpu the user consumed and prices an idle session at zero; session time bills the R server they are holding, whether it computes or not.",
    metric_execution_time: 'Execution time',
    metric_session_time: 'Session time',
    period: 'Window',
    period_hint: 'The rolling window the usage is summed over.',
    period_daily: 'Last 24 hours',
    period_weekly: 'Last 7 days',
    limit: 'Limit',
    limit_minutes: 'Limit (minutes)',
    limit_minutes_hint: 'R execution time allowed over the window. Zero forbids DataSHIELD altogether for this subject.',
    limit_minutes_hint_session_time: 'How long the R sessions may stay open over the window, idle time included. Zero forbids DataSHIELD altogether for this subject.',
    limit_below_execution_time: 'This session time limit is below the execution time limit of the same subject. A session lasts at least as long as the commands it runs, so the execution time limit can never be reached.',
    used: 'Used',
    usage_title: '{context} Quota',
    usage_used: '{used} of {limit} of {metric} used — {window}',
    usage_from_user: 'From a personal quota.',
    usage_from_group: 'From the quota of group "{principal}".',
    usage_from_system: 'From the system default quota.',
    usage_unlimited: 'No quota applies: {context} {metric} is unlimited.',
    usage_unavailable: 'Quota usage is not available.',
    usage_blocked: 'New {context} sessions are blocked. Sessions already open keep working.',
    usage_credit: 'Some capacity returns {distance}.',
    usage_open_sessions: '· {count} session open, still consuming | · {count} sessions open, still consuming',
    usage_close_sessions: 'Waiting does not help: close the session you are not using. | Waiting does not help: close the sessions you are not using.',
    set_personal: 'Set a personal quota',
    edit_personal: 'Edit this quota',
    enabled_hint: 'A disabled quota does not apply, and does not exempt its subject either: the quota of a group, or the system default, applies instead.',
  },
  resource_ref: {
  ...
  extract: 'Extract',
  failed: 'Failed',
  file_bundle_cancelled: 'File download preparation was cancelled.',
  file_bundle_failed: 'File download preparation failed.',
  ...
  gh_repo: 'Repository',
  go_to_files: 'View files',
  go_to_tables: 'View tables',
  go_to_resources: 'View resources',
  group: 'Group',
  ...
  internal_database_hint: 'Opal creates a database for this project and deletes it with the project.',
  intervals: 'Intervals',
  ...
  refresh: 'Refresh',
  registered_database_hint: 'Data is left in place when the project is deleted.',
  register: 'Register',
  reload: 'Reload',
