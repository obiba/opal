export default {
  ...
  r_quota: {
    title: 'Quotas',
    info: 'A quota limits the R execution time a user may spend on DataSHIELD over a rolling window. The window rolls: there is no reset, capacity returns as past activity ages out of it. A user gets their own quota if they have one, otherwise the most permissive of the quotas of the groups they belong to, otherwise the system default. Where none of these applies, usage is unlimited.',
    add: 'Add quota',
    edit: 'Edit quota',
    ...
    period: 'Window',
    period_hint: 'The rolling window the execution time is summed over.',
    ...
    usage_used: '{used} of {limit} used — {window}',
    ...
    usage_unlimited: 'No quota applies: {context} usage is unlimited.',
    usage_unavailable: 'Quota usage is not available.',
    usage_blocked: 'New {context} sessions are blocked until capacity returns. Sessions already open keep working.',
