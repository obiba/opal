export default {
  ...
  r_quota: {
    title: 'Quotas',
    info: "Un quota limite le temps d'exécution R qu'un utilisateur peut consacrer à DataSHIELD sur une fenêtre glissante. La fenêtre glisse : il n'y a pas de remise à zéro, la capacité revient à mesure que l'activité passée sort de la fenêtre. Un utilisateur se voit appliquer son propre quota s'il en a un, sinon le plus permissif des quotas des groupes auxquels il appartient, sinon le quota par défaut du système. Si aucun ne s'applique, l'usage est illimité.",
    ...
    period: 'Fenêtre',
    period_hint: "La fenêtre glissante sur laquelle le temps d'exécution est cumulé.",
    ...
    usage_used: '{used} sur {limit} consommés — {window}',
    ...
    usage_unlimited: "Aucun quota ne s'applique : l'usage {context} est illimité.",
    usage_unavailable: "La consommation du quota n'est pas disponible.",
    usage_blocked: "Les nouvelles sessions {context} sont bloquées jusqu'au retour de capacité. Les sessions déjà ouvertes continuent de fonctionner.",
