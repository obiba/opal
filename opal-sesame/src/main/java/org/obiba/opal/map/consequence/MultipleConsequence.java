 ...
 *
 */
public class MultipleConsequence implements AttributeRuleConsequence {

  private List<AttributeRuleConsequence> consequences;

  public void apply(GraphBuilder builder, DataItemAttribute dataItemAttribute) {
    for(AttributeRuleConsequence consequence : consequences) {
      consequence.apply(builder, dataItemAttribute);
    }
  }
}
