...
def add_arguments(parser):
    ...
    parser.add_argument('--install', '-in', required=False, help='Install a plugin by providing its name or name:version. If no version is specified, the latest version is installed. Requires system restart to be effective.')
