...
public class ReportTemplateUpdatedEvent extends GwtEvent<ReportTemplateUpdatedEvent.Handler> {
  ...
  public ReportTemplateUpdatedEvent(ReportTemplateDto reportTemplate) {
  ...
  protected void dispatch(Handler handler) {
    handler.onReportTemplateUpdated(this);
  }
