...
public abstract class AbstractOpalModule extends AbstractPresenterModule {
  ...
  protected <V extends WizardView, W extends WizardPresenterWidget<V>, P extends WizardProxy<W>> void bindWizardPresenterWidget(
      Class<W> presenter, Class<V> view, Class<? extends V> impl, Class<P> proxy) {
