...
(function (a) {
    ...
    a.jqplot.OHLCRenderer.prototype.draw = function (z, J, g) {
        ...
        t.bodyWidth = (q.bodyWidth != undefined) ? q.bodyWidth : t.bodyWidth;
        t.tickLength = (q.tickLength != undefined) ? q.tickLength : t.tickLength;
        z.save();
        if (this.show) {
            var l, p, f, L, s;
            ...
            if (t.candleStick) {
                if (typeof(t.bodyWidth) == "number") {
                    ...
                    t._bodyWidth = Math.min(20, z.canvas.width / (H - k) / 2)
                }
            } else {
                if (typeof(t.tickLength) == "number") {
                    t._tickLength = t.tickLength
                } else {
                    t._tickLength = Math.min(10, z.canvas.width / (H - k) / 4)
                }
            }
            for (var C = k; C < H; C++) {
                l = n(G[C][0]);
