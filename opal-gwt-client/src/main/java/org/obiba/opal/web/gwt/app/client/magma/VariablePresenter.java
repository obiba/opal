...
import org.obiba.opal.web.gwt.app.client.magma.derive.DeriveVariablePresenter;
...
import org.obiba.opal.web.gwt.app.client.magma.variable.NamespacedAttributesTableUiHandlers;
...
import static org.obiba.opal.web.gwt.app.client.magma.variable.BaseVariableAttributeModalPresenter.Mode;
...
public class VariablePresenter extends PresenterWidget<VariablePresenter.Display>
  ...
  public void onAddToCart() {
    fireEvent(new CartAddVariableEvent(table.getEntityType(), table.getDatasourceName(), table.getName(), variable));
  }
