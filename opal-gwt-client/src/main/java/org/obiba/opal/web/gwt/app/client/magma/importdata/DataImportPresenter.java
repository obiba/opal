...
import org.obiba.opal.web.gwt.app.client.magma.importvariables.ComparedDatasourcesReportStepPresenter;
...
public class DataImportPresenter extends WizardPresenterWidget<DataImportPresenter.Display> {
  ...
  private void submitJob(ImportCommandOptionsDto dto) {
    ResourceRequestBuilderFactory.newBuilder() //
        ...
        .withCallback(SC_CREATED, new SubmitJobResponseCodeCallBack()) //
        .send();
  }
