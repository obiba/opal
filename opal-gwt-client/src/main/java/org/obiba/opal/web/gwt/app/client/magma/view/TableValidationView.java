...
import org.obiba.opal.web.gwt.app.client.magma.presenter.TableValidationPresenter.DataFetcher;
import org.obiba.opal.web.gwt.app.client.magma.presenter.TableValidationPresenter.EntitySelectionHandler;
...
public class TableValidationView
    extends ViewWithUiHandlers<ValuesTableUiHandlers>
  ...
  //@UiTemplate("TableValidationView.ui.xml")
  ...
  private TableValidationPresenter.ViewMode viewMode = TableValidationPresenter.ViewMode.DETAILED_MODE;
  ...
  @Override
  public void addEntitySearchHandler(final TableValidationPresenter.EntitySearchHandler handler) {
  ...
  @Override
  public void setViewMode(TableValidationPresenter.ViewMode mode) {
    viewMode = mode;
    searchPanel.setVisible(viewMode == TableValidationPresenter.ViewMode.DETAILED_MODE);
  ...
  private AbstractSafeHtmlCell<String> createColumnHeaderCell() {
    if(viewMode == TableValidationPresenter.ViewMode.SIMPLE_MODE) {
      return new TextCell();
    }
  ...
  private void initValuesTable() {
    ...
    Column<ValueSetDto, ?> entityColumn = viewMode == TableValidationPresenter.ViewMode.SIMPLE_MODE
  ...
  private final class ValueSetsDataProvider extends AbstractDataProvider<ValueSetDto>
  ...
  private final class EntitySelectionHandlerImpl implements EntitySelectionHandler {
