 ...
 *
 */
public class ValueMapPopupView extends PopupViewImpl implements ValueSequencePopupPresenter.Display {

  @UiTemplate("ValueSequencePopupView.ui.xml")
  interface ValueSequencePopupViewUiBinder extends UiBinder<Widget, ValueMapPopupView> {}
