...
public class ScriptEvaluationHideEvent extends GwtEvent<ScriptEvaluationHideEvent.Handler> {

  private static Type<Handler> TYPE = new Type<Handler>();

  public ScriptEvaluationHideEvent() {
  }
  ...
  protected void dispatch(Handler handler) {
    handler.onScriptEvaluationHide(this);
  }
