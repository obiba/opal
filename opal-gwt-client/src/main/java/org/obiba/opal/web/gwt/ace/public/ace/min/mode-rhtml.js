define("ace/mode/rhtml", ["require", "exports", "module", "ace/lib/oop", "ace/mode/html", "ace/tokenizer", "ace/mode/rhtml_highlight_rules"], function (e, t, n) {
    ...
    var r = e("../lib/oop"), i = e("./r_highlight_rules").RHighlightRules, s = e("./html_highlight_rules").HtmlHighlightRules, o = e("./text_highlight_rules").TextHighlightRules, u = function () {
        this.$rules = (new s).getRules(), this.$rules.start.unshift({token: "support.function.codebegin", regex: "^<!--\\s*begin.rcode\\s*(?:.*)", next: "r-start"});
        var e = (new i).getRules();
        this.addRules(e, "r-"), this.$rules["r-start"].unshift({token: "support.function.codeend", regex: "^\\s*end.rcode\\s*-->", next: "start"})
    };
