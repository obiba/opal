...
public class ArchiveStepPresenter extends PresenterWidget<ArchiveStepPresenter.Display> {
  ...
  @Inject
  public ArchiveStepPresenter(final EventBus eventBus, final Display display, FileSelectionPresenter archiveFolderSelectionPresenter) {
  ...
  public void updateImportData(ImportData importData) {
    importData.setArchiveLeave(getView().isArchiveLeave());
    importData.setArchiveMove(getView().isArchiveMove());
    importData.setArchiveDirectory(getView().getArchiveDirectory());
  }
