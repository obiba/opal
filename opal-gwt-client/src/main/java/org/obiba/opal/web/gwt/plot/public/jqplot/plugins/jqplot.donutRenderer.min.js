...
(function (e) {
    ...
    function h() {
        ...
        if (o.length) {
            o.before(this.plugins.donutRenderer.highlightCanvas.createElement(this._gridPadding, "jqplot-donutRenderer-highlight-canvas", this._plotDimensions))
        } else {
