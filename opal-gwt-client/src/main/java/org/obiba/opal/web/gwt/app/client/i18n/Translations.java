...
public interface Translations extends Constants {
  ...
  @DefaultStringMapValue( { "NOT_STARTED", "Not Started", "IN_PROGRESS", "In Progress", "SUCCEEDED", "Succeeded", "FAILED", "Failed", "CANCEL_PENDING", "Cancel Pending", "CANCELED", "Cancelled", "DatasourceCreationFailed", "The datasource creation has failed." })
