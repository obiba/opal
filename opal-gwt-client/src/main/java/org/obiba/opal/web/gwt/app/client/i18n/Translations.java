...
public interface Translations extends Constants {
  ...
  @DefaultStringMapValue( { "clearJobsList", "Clear Jobs List", "cancelJob", "Cancel Job", "replaceExistingFile", "Replace File", "deleteFile", "Delete File", "removeDatasource", "Remove Datasource" })
