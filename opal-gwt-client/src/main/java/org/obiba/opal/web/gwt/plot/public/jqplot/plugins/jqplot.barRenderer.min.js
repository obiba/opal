...
(function (d) {
    ...
    function g(t, p, o, w) {
        ...
        if (this.rendererOptions.waterfall == true) {
            ...
            var s = 0;
            var u = (!this.rendererOptions.barDirection || this.rendererOptions.barDirection == "vertical") ? 1 : 0;
    ...
    d.jqplot.BarRenderer.prototype.draw = function (E, J, q) {
        var G;
        var A = (q != undefined) ? q : {};
        var v = (A.shadow != undefined) ? A.shadow : this.shadow;
        var M = (A.showLine != undefined) ? A.showLine : this.showLine;
        ...
        if (M) {
            ...
            if (this.barDirection == "vertical") {
                for (var G = 0; G < J.length; G++) {
                    ...
                    points.push([r - this.barWidth / 2, o]);
                    points.push([r - this.barWidth / 2, J[G][1]]);
                    points.push([r + this.barWidth / 2, J[G][1]]);
                    points.push([r + this.barWidth / 2, o]);
                    ...
                    if (v && !this._stack) {
                        ...
                        delete z.fillStyle;
                        this.renderer.shadowRenderer.draw(E, points, z)
                    }
                    var n = A.fillStyle || this.color;
                    this._dataColors.push(n);
                    this.renderer.shapeRenderer.draw(E, points, A)
                }
            } else {
                if (this.barDirection == "horizontal") {
                    for (var G = 0; G < J.length; G++) {
                        ...
                        points.push([N, r + this.barWidth / 2]);
                        points.push([N, r - this.barWidth / 2]);
                        points.push([J[G][0], r - this.barWidth / 2]);
                        points.push([J[G][0], r + this.barWidth / 2]);
                        this._barPoints.push(points);
                        if (v && !this._stack) {
                            var z = d.extend(true, {}, A);
    ...
    d.jqplot.BarRenderer.prototype.drawShadow = function (z, E, p) {
        var B;
        var w = (p != undefined) ? p : {};
        var s = (w.shadow != undefined) ? w.shadow : this.shadow;
        var G = (w.showLine != undefined) ? w.showLine : this.showLine;
        ...
        if (this._stack && this.shadow) {
            ...
            if (this._stack) {
                ...
                this._barNudge = (-Math.abs(t / 2 - 0.5) + r) * (this.barWidth + this.barPadding)
            }
            if (G) {
                if (this.barDirection == "vertical") {
                    for (var B = 0; B < E.length; B++) {
                        ...
                        points = [];
                        var q = E[B][0] + this._barNudge;
                        var n;
                        if (this._stack && this._prevGridData.length) {
                            n = this._prevGridData[B][1]
                        } else {
                            if (this.fillToZero) {
                        ...
                        points.push([q - this.barWidth / 2, n]);
                        points.push([q - this.barWidth / 2, E[B][1]]);
                        points.push([q + this.barWidth / 2, E[B][1]]);
                        points.push([q + this.barWidth / 2, n]);
                        this.renderer.shadowRenderer.draw(z, points, w)
                    }
                } else {
                    if (this.barDirection == "horizontal") {
                        for (var B = 0; B < E.length; B++) {
                            ...
                            points.push([H, q + this.barWidth / 2]);
                            points.push([E[B][0], q + this.barWidth / 2]);
                            points.push([E[B][0], q - this.barWidth / 2]);
                            points.push([H, q - this.barWidth / 2]);
                            this.renderer.shadowRenderer.draw(z, points, w)
                        }
    ...
    function h(p, o, n) {
        for (i = 0; i < this.series.length; i++) {
            if (this.series[i].renderer.constructor == d.jqplot.BarRenderer) {
    ...
    function j() {
        ...
        var n = this.plugins.barRenderer.highlightCanvas.setContext()
    }
