...
/**
 * {@link FactoryBean} that retrieves the JTA UserTransaction/TransactionManager for ObjectWeb's <a
 ...
 * </pre>
 * <p/>
 * Note that Spring's {@link JtaTransactionManager} will automatically detect that the passed-in UserTransaction
