...
public class DefaultCommandJobService implements CommandJobService {
   ...
   * 
   * The id is generated by simply incrementing (by 1) the id of the most recently launched job.
   * 
   * @return a unique id for a {@link CommandJob}
   */
  protected synchronized Long generateId() {
    return !getHistory().isEmpty() ? getHistory().get(0).getId() + 1 : 1;
  }
