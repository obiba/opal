...
public class ProjectCommandsCopyResource extends AbstractProjectCommandsResource {
  ...
  @POST
  @Operation(
    summary = "Copy data between projects",
    description = "Copies data tables from one project/datasource to another within Opal."
  )
  @ApiResponses({
    @ApiResponse(responseCode = "201", description = "Copy command successfully launched"),
