...
public class DatashieldPackagesHandlerTest {

  @Test
  public void test_methods() {
    Collection<DataShield.DataShieldMethodDto> dtos = DatashieldPackagesHandler.parsePackageMethods("dsBase", "1.0", ",colnames, ls=base::ls, ");
